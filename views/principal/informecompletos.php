...
<div class="modal fade" id="Modal_Agruapdo" style="overflow:hidden;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row g-9 mb-8">
                    ...
                    <div class="col-md-12 fv-row fv-plugins-icon-container">
                        ...
                        <select class="select22" id="AGR_TIPO">
                    ...
                    <div class="col-md-12 fv-row fv-plugins-icon-container">
                        <label class="required fs-6 fw-semibold mb-2">Comentario</label>
                        <textarea id="AGR_COMEN" class="form-control"></textarea>
                    </div>
...
<?php require 'funciones/informecompletojs.php'; ?>
